...
public class JwtTokenProvider {
	...
	public JwtTokenRespDto createToken(Authentication authentication) {
		...
		// (PrincipalUserDetails) 으로 다운 캐스팅
	...
	public boolean validateToken(String token) {
		try {
			...
			// Security 라이브러리에 오류가 있거나, JSON의 포맷이 잘못된 JWT가 들어왔을 떄 예외
	...
	public Authentication getAuthentication(String accessToken) {
		...
		Claims claims = parseclClaims(accessToken);
	...
	private Claims parseclClaims(String accessToken) {
		try {
